...
const Search = () => {
   ...
   const onSubmit = data => {
    ...
    return (
        <>
        {/* <div  className="mt-5"  style={{ background: "#EFEFEF", borderRadius: "10px" }}>
            <form onSubmit={handleSubmit(onSubmit)}>
              <label for=""> pick from</label>
              <div className="form-control">
              <input type="text"  {...register("pickFrom")} defaultValue={search.pickFrom} />   
              </div>
              <label for=""> pick to</label>
              <div className="form-control">
              <input type="text"   {...register("pickTo")} defaultValue={search.pickTo} />   
              </div>
              <label for=""> Date</label>
              <div className="form-control">
              <input type="date"   {...register("date")} defaultValue={search.date} />   
              </div>
